        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <a class="logo" href="{{url('mentor/dashboard')}}">
                        <b>
        ...
        <aside class="sidebar" role="navigation">
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="side-menu">
                        <li>
                            <a href="/mentor/dashboard" aria-expanded="false"><i class="icon-home fa-fw"></i> <span class="hide-menu">  Beranda</span></a>
                        </li>
                        <li>
                            <a href="/mentor/classroom" aria-expanded="false"><i class="icon-note fa-fw"></i> <span class="hide-menu">  Skoring</span></a>
                        </li>
                        <li>
                            <a href="/mentor/edit" aria-expanded="false"><i class="icon-settings fa-fw"></i> <span class="hide-menu">  Edit Akun</span></a>
                        </li>
                    </ul>
                </nav>
                @else
