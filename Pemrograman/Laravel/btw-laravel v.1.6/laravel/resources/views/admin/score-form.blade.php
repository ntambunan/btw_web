...
<?php $nav_custom = url('/admin/classroom/'.$classroom_id.'/lesson/'.$lesson_id.'/score') ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form action="/admin/classroom/{{$classroom_id}}/lesson/{{$lesson_id}}/score/form" method="post">
                        @csrf
