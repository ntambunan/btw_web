    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Mentor Mendaftar</h3>
                        <p class="text-muted m-b-30">Melihat user yang mendaftar sebagai mentor</p>
                            ...
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $index += 1; ?>
                                        <td>{{$row['email']}}</td>
                                        <td><a href="/admin/mentor/form/{{$row['id']}}">Verify</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
