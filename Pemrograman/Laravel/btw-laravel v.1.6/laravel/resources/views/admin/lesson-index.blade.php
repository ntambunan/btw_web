                ...
                <div class="col-sm-12">
                    <div class="white-box">
                            ...
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $index += 1; ?>
                                        <td>{{$row['date']}}</td>
                                        <td><a href="/admin/classroom/{{$row['classroom_id']}}/lesson/{{$row['id']}}/score">Lihat Nilai</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        @if ($classroom->is_active == 1)
                            <a class="btn btn-primary mt-5" href="/admin/classroom/{{$classroom->id}}/lesson/form" style="width: 100%">Tambah Lesson</a>
                        @else
